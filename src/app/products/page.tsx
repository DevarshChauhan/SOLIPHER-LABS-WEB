...
import { Layers, Scissors, ArrowRight, Network, type LucideIcon } from "lucide-react";
        ...
        <Container>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            {products.map((product, i) => {
              ...
              return (
                <FadeInView key={product.slug} index={i + 1} className="flex flex-col rounded-2xl border border-border bg-surface p-8">
