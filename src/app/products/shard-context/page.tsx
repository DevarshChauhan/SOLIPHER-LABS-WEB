            ...
            <div className="rounded-2xl border border-border bg-background p-6">
              ...
              <ul className="mt-3 space-y-2.5">
                {[
                  ...
                  "Security CI gates wired into real automation: fmt, clippy, forbid(unsafe_code), overflow checks, 512 tests, fuzzing, dependency scanning",
                  ...
                  "The Reference Baseline frozen for real, version 1: a real build digest over every workspace crate's version, a real source-tree digest over the actual compiled bytes, and the real evaluation-fixture ids this project's own live runs produced, tagged and sealed so any future change now requires an explicit, documented revision decision, not a silent overwrite. The evaluation program itself remains partial, named honestly, not claimed complete by this freeze",
