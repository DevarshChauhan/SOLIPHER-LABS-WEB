...
const currentGaps = [
  ...
  "The full evaluation program still has real gaps: no p95 compile-latency measurement anywhere, and no dedicated controller microbenchmark (Stratum A). The ablations baseline is now real for three of its four components (see Real today); the fourth, stable-prefix policy, isn't exercised since no real caching mechanism exists in this codebase yet to disable.",
];
