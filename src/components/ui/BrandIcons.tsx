...
export function XIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M13.6 10.6 20.4 3h-1.9l-5.9 6.6L7.9 3H2l7.2 10.2L2.4 21h1.9l6.3-7 5 7H21l-7.4-10.4Zm-2.2 2.5-.7-1L4.9 4.4h2.4l4.7 6.6.7 1 6.1 8.6h-2.4l-5-7Z" />
    </svg>
  );
}
